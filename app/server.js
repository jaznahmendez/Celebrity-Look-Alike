...
app.get('/racoon-pedro.gif', (req, res) => {
    res.sendFile(path.join(__dirname, 'images/racoon-pedro.gif'));
});

app.get('/star.ico', (req, res) => {
    res.sendFile(path.join(__dirname, 'images/star.ico'));
});

app.get('/star.png', (req, res) => {
    res.sendFile(path.join(__dirname, 'images/star.png'));
});

app.get('/star2.png', (req, res) => {
    res.sendFile(path.join(__dirname, 'images/star2.png'));
});
